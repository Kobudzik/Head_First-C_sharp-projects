    ...
    static class InvadersHelper
    {
        ...
        public static FrameworkElement StarControlFactory(Point point, double scale)
        {
            ...
            switch (_random.Next(3))
            {
                ...
                default:
                    star = new BigStar();
                    ((BigStar)star).SetFill(new SolidColorBrush(GetRandomStarColor()));
                    break;
                };
        ...
        public static FrameworkElement ShipControlFactory(Ship ship, double scale)
        {
            ...
            if (ship is Invader)
            {
                ...
                shipImage = new AnimatedImage(GenerateImageList(invader.InvaderType), TimeSpan.FromMilliseconds(500));
            }
            else if (ship is Player)
            {
                Player player = ship as Player;
                shipImage = new AnimatedImage(new List<string>() { "player.png", "player.png" }, TimeSpan.FromSeconds(1));
            }
        ...
        public static IEnumerable<string> GenerateImageList(InvaderType invaderType)
        {
            ...
            if (!string.IsNullOrEmpty(fileName))    //DODAJE każdą klatkę
            {
                int numImages = 4;
        ...
        public static DoubleAnimation CreateDoubleAnimation(UIElement control, double from, double to, string property)
        {
        ...
        public static DoubleAnimation CreateDoubleAnimation(UIElement control, double from, double to, string property, TimeSpan duration)
        {
