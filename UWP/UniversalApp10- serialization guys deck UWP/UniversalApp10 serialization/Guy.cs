...
{
    [DataContract(Namespace = "UniversalApp10_serializationXML")]
    class Guy
    {
        ...
        [DataMember] public int Age { get; private set; }
        [DataMember] public decimal Cash { get; private set; }
        [DataMember(Name = "MyCard")] public Card TrumpCard { get; set; }
