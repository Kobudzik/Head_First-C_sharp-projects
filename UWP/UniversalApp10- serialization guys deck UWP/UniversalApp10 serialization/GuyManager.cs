...
namespace UniversalApp10_serialization
{
    class GuyManager : INotifyPropertyChanged
    {
        ...
        public async void ReadGuyAsync()// to read
        {
        ...
        public async void WriteGuyAsync(Guy guyToWrite)//to save
        {
            IStorageFolder guysFolder = await KnownFolders.DocumentsLibrary.CreateFolderAsync("Guys", CreationCollisionOption.OpenIfExists);
