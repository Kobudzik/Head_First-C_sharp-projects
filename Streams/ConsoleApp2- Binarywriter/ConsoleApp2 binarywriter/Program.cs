...
namespace ConsoleApp2_binarywriter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //odczyt wszystkich bajtów do tablicy
            byte[] dataWritten = File.ReadAllBytes("binarydata.dat");
            
            //wypisuje po bajcie sformatowane: x=szesnastowo i spacje
            ...
            //otworzenie pliku do zmiennej input
            using (FileStream input = File.OpenRead("binarydata.dat"))
            
            //utworzenie binary readera
